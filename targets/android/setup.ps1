...
Push-Location -Path "$env:ANDROID_HOME\tools\bin"
	...
	cmd.exe /c "sdkmanager.bat platform-tools build-tools;29.0.1 tools platforms;android-29 cmake;3.10.2.4988404 ndk;$NDK_VERSION"
Pop-Location
...
if (!(Test-Path "..\..\third-party\SDL")) {
	...
	Write-Host "SDL download complete"
